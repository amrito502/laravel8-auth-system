        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="card-title dm-sans" style="font-size: 22px; font-weight: 700; color:#5660d9;">Add Team Member</h6>
                    <a href="{{ route('admin.team') }}" class="btn btn-success dm-sans"><i data-feather="eye"></i> All Team Members</a>
                </div>


                <form class="mt-4" action="{{ route('admin.store.team') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="btn_submit d-flex justify-content-end mx-5 mt-3">
                        <button class="btn btn-primary mx-4" type="submit"><i data-feather="plus"></i> Add Team Member</button>
                    </div>
                </form>
