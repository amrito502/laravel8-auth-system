    ...
    <div class="col-lg-10 grid-margin stretch-card">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="mt-4" action="{{ route('admin.update.hero',$hero_id->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" name="name" id="name" type="text" value="{{ $hero_id->name }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" name="title" id="title" value="{{ $hero_id->title }}" type="text"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-8">
                            <img src="{{ asset('images/hero/'.$hero_id->image) }}" alt="hero" style="width: 100px">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-8">
                            <textarea class="form-control" name="description" id="description" rows="8"
                                placeholder="Write Hero Description..">{{ $hero_id->description }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="seo my-2">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <textarea class="form-control" name="meta_description" id="meta_description" rows="8">{{ $hero_id->meta_title }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control input_tag_cus" name="mete_keyword" id="tags" value="{{ $hero_id->mete_keyword }}" data-role="tagsinput" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="form-check mb-2">
                            <input type="checkbox" name="status" {{ $hero_id->status == '1' ? 'checked':'' }} class="form-check-input" id="status"
                    ...
                    <div class="btn_submit d-flex justify-content-end mx-5 mt-3">
                        <button class="btn btn-primary mx-4" type="submit"><i data-feather="plus"></i> Edit Hero</button>
                    </div>
                </form>
