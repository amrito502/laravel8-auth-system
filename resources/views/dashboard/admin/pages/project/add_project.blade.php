...
@section('admin_content')
    <div class="col-lg-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4 dm-sans" style="font-size: 22px; font-weight: 700; color:#5660d9;">Add Project Form</h4>
                <form action="{{ route('admin.store.project') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="btn_submit d-flex justify-content-end mx-5 mt-3">
                        <input class="btn btn-primary mx-2" type="submit" value="Add Project">
                    </div>
                </form>
            </div>
        </div>
