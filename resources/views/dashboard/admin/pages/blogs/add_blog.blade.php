        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="card-title dm-sans" style="font-size: 22px; font-weight: 700; color:#5660d9;">Add Blog Posts</h6>
                    <a href="{{ route('admin.blog') }}" class="btn btn-success dm-sans"><i data-feather="eye"></i> All Blog</a>
                </div>


                <form class="mt-4" action="{{ route('admin.store.blog') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-8">
                            <textarea class="form-control" name="short_description" id="" rows="8"
                                placeholder="Write Blog Short description"></textarea>
                            <span class="text-danger">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-8">
                            <textarea class="form-control" name="long_description" id="summernote" rows="8"
                                placeholder="Write Blog Long description"></textarea>
                            <span class="text-danger">
                    ...
                    <div class="btn_submit d-flex justify-content-end mx-5 mt-3">
                        <button class="btn btn-primary mx-4" type="submit"><i data-feather="plus"></i> Add Blog</button>
                    </div>
                </form>
