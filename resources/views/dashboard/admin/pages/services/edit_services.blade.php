...
@section('admin_content')
    <div class="col-lg-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4 dm-sans" style="font-size: 22px; font-weight: 700; color:#5660d9;">Edit Services Form</h4>
                <form action="{{ route('admin.update.services',$service->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-lg-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <textarea class="form-control" name="description" id="defaultconfig-4" rows="8">{{ $service->description }}</textarea>

                        </div>
                    </div>
                    <div class="btn_submit d-flex justify-content-end mx-5 mt-3">
                        <input class="btn btn-primary mx-2" type="submit" value="Update Service">
                    </div>
                </form>
            </div>
        </div>
