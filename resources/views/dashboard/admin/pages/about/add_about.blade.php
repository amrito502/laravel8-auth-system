    ...
    <div class="col-lg-10 grid-margin stretch-card">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="mt-4" action="{{ route('admin.store.about') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-8">
                            <textarea class="form-control" name="description" id="description" rows="8"
                                placeholder="Write About Description.."></textarea>
                            <span class="text-danger">
                                @error('description')
                                {{ $message }}
                                @enderror
                    ...
                    <div class="btn_submit d-flex justify-content-end mx-5 mt-3">
                        <button class="btn btn-primary mx-4" type="submit"><i data-feather="plus"></i> Add About</button>
                    </div>
                </form>
